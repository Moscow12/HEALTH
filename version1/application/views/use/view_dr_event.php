<?php if($this->session->flashdata('doctor_events')):  ?>    
    <?php echo '<p class="alert alert-success">'.$this->session->flashdata('doctor_events'). '</p>'; ?>
<?php endif; ?>
        ...
        <div class="card">
            ...
            <div class="card card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        <th><?php echo $namb++; ?></th>
                        <td id="title"><?php echo $serv['title'];?> </td>
                        <td id="location"><?php echo $serv['location'];?> </td>
                        <td id="desc"><?php echo $serv['description']; ?> </td>
