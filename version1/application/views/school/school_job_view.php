    ...
    <table style="background:#cc4; width:80%; align:center; border-radius:10%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span><a href="view_job1_desc/<?php echo $jobs['id']; ?>" class="btn btn-info" value="<?php echo $jobs['id']; ?>"><i class="glyphicon eye-open">View</i> </a>
                                <a href="delete/<?php echo $jobs['id'];?> " class="btn btn-info" value="<?php echo $jobs['id']; ?>">Delete</a></span> </td>
                            </tr>
